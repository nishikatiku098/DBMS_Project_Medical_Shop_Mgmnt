<%-- 
    Document   : 1
    Created on : 3 Oct, 2018, 6:31:52 PM
    Author     : NISHIKA TIKU
--%>
            ...
            <table border="0" cellspacing="25" cellpadding="25">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" name="uname" placeholder="Name" required="required"
 value="" id="uname" onblur="FormValidation4()" size="25" /></td>
                    </tr>
                    <tr>
    ...
    if(upassword === ""){
       ...
       return false;
        ...
        return true;
            ...
            <br><br> <h1><font face="ink free" color="black" size="4"><b>Not Registered?</font></h1>
            <a href="register.jsp"><font face="ink free" color="red" size="4"><b>Register Now</form></a>        
